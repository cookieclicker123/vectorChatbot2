...
sys.path.append("/path/to/chat_with_retrieval")  # Replace "/path/to/chat_with_retrieval" with the actual path

import streamlit as st
from streamlit.external.langchain import StreamlitCallbackHandler

from chatWithDocuments import configure_retrieval_chain
from theUtils import MEMORY, DocumentLoader
